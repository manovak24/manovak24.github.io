        ...
        return(
            <div className="about-container">
                ...
                <div className="bio-container">
                    <Link className="button-link" to={Resume} target="_blank" download>Click here to download a copy of my Resume</Link>
                    <p>Thank you for visiting my website! My name is Mark Novak. I am a web developer based in Marquette, Michigan. Originally from the suburbs of Chicago, I made the move to the Upper Peninsula in 2008 to attend Northern Michigan University where I studied Finance & Risk Management. In addition, I played on the DII ACHA hockey team for five years, being an academic all start for my final two years. After completing my undergraduate degree I was admitted as a graduate assistant to the Masters of Business Administration program at NMU.</p>
